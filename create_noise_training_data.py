...
def main():
    ...
    parser.add_argument("--output", type=str, default="training_data", help="Output text file path.")
    parser.add_argument("--typo_probability", type=float, default=0.15, help="Probability of introducing typos (default is 0.1).")
    parser.add_argument("--max_lines", type=int, default=1000, help="Maximum number of lines to process (default is 1000).")
    ...
    if args.language == 'chinese':
        process_chinese(args.input, args.max_lines, args.output)
